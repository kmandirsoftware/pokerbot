...
def current_hand(player_cards, dealer_cards):
    ...
    answer=f"You currently have a {hand_values[value]} !\n"
    answer+=f"Your high card is a(n): {card_values[high_card]}\n"
    answer+=f"This hand has a value of: {value} out of 9.\n"
    print(answer)
    return answer
...
def opponent_hands(dealer_cards, player_cards, best_hand, value):
    ...
    for string in all_possible_cards_copy:
        all_possible_enemy_cards.append(cards.Card(string[0], string[1]))
